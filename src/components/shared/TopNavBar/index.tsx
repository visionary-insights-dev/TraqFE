...
export const TopNavBar = ({
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-50 mx-auto flex min-h-16 w-full max-w-7xl items-center justify-between border-b border-[var(--border-subtle)] bg-white/90 px-4 backdrop-blur-md sm:px-6 lg:px-8",
        className
      )}
      {...props}
    >
      ...
      {isMenuOpen ? (
        <nav
          ...
          className="absolute inset-x-0 top-full border-b border-[var(--border-subtle)] bg-white px-4 pb-5 pt-3 shadow-lg md:hidden"
        >
          <button
            type="button"
